  ...
  properties: {
    personalInfo: {
      ...
      properties: {
        ...
        placeOfResidence: { type: Type.STRING, description: "Woonplaats. Alleen invullen als duidelijk in bron staat. Anders leeg laten." },
        gender: { type: Type.STRING, description: "Geslacht (Man / Vrouw / Anders). Alleen invullen als expliciet vermeld in bron. Anders leeg laten." },
        holidaySchedule: { type: Type.STRING, description: "Vakantieschema / niet-beschikbaarheid (bv. '5-19 juli' of 'geen vakantie gepland'). Alleen invullen als in bron staat. Anders leeg laten." },
      },
